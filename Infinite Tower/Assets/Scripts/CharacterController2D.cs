...
public class CharacterController2D : MonoBehaviour
{
    ...
    private Vector3 _activeLocalPlatformPoint, _activeGlobalPlatformPoint;
    ...
    public void AddForce(Vector2 force) { _velocity += force; }
    public void SetForce(Vector2 force) {
        _velocity = force;
        State.IsFacingRight = _velocity.x > 0;
    }
    public void SetHorizontalForce(float x) { _velocity.x = x; }
    public void SetVerticalForce(float y) { _velocity.y = y; }
    public void Jump()
    {
    ...
    private void Move(Vector2 deltaMovement) {
        ...
        if (State.IsCollidingLeft || State.IsCollidingRight) {
            SetForce(new Vector2(-_velocity.x, _velocity.y));
        }
    ...
    private void MoveVertically(ref Vector2 deltaMovement)
    {
        ...
        for (var i = 0; i < TotalVerticalRays; i++) {
            ...
            if (!isGoingUp) {
                var verticalDistanceToHit = _transform.position.x - raycastHit.point.y;
